...
<!--  
	...
	강제화하고 있다. 이 구조를 모른다면 제대로 동작하는 프로그램을 개발할 수 없게 된다.
	...
	... WEB_INF/사용자 : 사용자폴더, css, js, html등등 사용자가 작성한 파일이 위치하는 폴더
...
<body>
	...
	<a href="http://localhost:8088/jsp01_basic/jsp03_process/jsp01_process.jsp">aaa</a><br>
	<!-- http://localhost:8088/jsp03_process/jsp01_process.jsp -->
	<a href="/jsp03_process/jsp01_process.jsp">bbb</a><br>
	<a href="/jsp01_basic/jsp03_process/jsp01_process.jsp">ccc</a><br>
	<a href="../jsp03_process/jsp01_process.jsp">ddd</a><br>
</body>
</html>