...
<!--  
	...
	out객체는 웹브라우저에 데이터를 전송하는 출력스트림으로서 jsp가 생서한 데이터를 웹페이지에
	출력한다.
	...
	2) out객체의 buffer관련메서드
	   ...
	   c. clear()         : 버퍼전체를 비움, 이미 flush가 되어 있다면 익셉션이 발생
	   d. clearBuffer()   : 버퍼전체를 비움, 이미 flush가 되어 있다면 익셉션이 발생 하지 않음
	   e. fulsh()         : 버퍼를 flush처리
...
<body>
	<% out.print("<h1>안녕하세요? out기본객체입니다!!</h1>"); %>
	<% out.print("안녕하세요?"); %>
	<% out.print("반갑습니다"); %>
