...
public class NullParamterReqWrapper extends HttpServletRequestWrapper {

	private Map<String, String[]> paramsMap = null;
	
	public NullParamterReqWrapper(HttpServletRequest req) {
		super(req);
		paramsMap = new HashMap<String, String[]>(req.getParameterMap());
	}

	// http://localhost:8088/jsp07_filter/jsp01_nullparam.jsp?id=hong&name=gildon&member=true
